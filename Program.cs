...
namespace lab4_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] directiry = Directory.GetFiles(@"D:\projects");
            ...
            for (int i = 0; i < directiry.Length; i++)
            {
                ...
                try
                {
                    ...
                    {
                        using (StreamWriter sw = new StreamWriter(@"D:\projects\no_file.txt", true, System.Text.Encoding.Default))
                        {
        ...
        public static int[] ReadAllInf(string directiry)
        {
            ...
            if (inform.Length > 2)
            {
                ...
                using (StreamWriter sw = new StreamWriter(@"D:\projects\bad_data.txt", true, System.Text.Encoding.Default))
                {
                    sw.Write(directiry + "\n");
                    return array;
                }
        ...
        public static int TryFindProduct(int[] array, string directiry)
        {
            ...
            {
                using (StreamWriter sw = new StreamWriter(@"D:\projects\overflow.txt", true, System.Text.Encoding.Default))
                {
                    sw.Write(directiry + "\n");
                }
            }
